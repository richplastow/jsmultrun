...
(function(_oG) {
/*! Jsmultrun 0.0.1 //// MIT Licence //// http://jsmultrun.richplastow.com/ */
var JsMultRun, SomeClass, Tudor, _o, _oN, _oV, tudor,
...
Tudor = (function() {
  ...
  Tudor.prototype.add = function(lines) {
    ...
    if (_o.A !== _o.type(lines)) {
      throw Error("`lines` isn’t an array" + _o.type(lines) + "/" + _o.A);
    }
    if (0 === lines.length) {
...
tudor.add([
  "01 JsMultRun Constructor", tudor.is, "The class and instance are expected types", "The JsMultRun class is a function", _o.F, function() {
    return JsMultRun;
